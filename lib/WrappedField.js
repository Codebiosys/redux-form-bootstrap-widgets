...
var ReduxField = function ReduxField(props) {
  return _react2.default.createElement(_reduxForm.Field, (0, _lodash.omit)(props, [].concat(_toConsumableArray((0, _lodash.keys)(_reduxForm.propTypes)), ['clearSubmitErrors'])));
};

var ReduxFields = function ReduxFields(props) {
  return _react2.default.createElement(_reduxForm.Fields, (0, _lodash.omit)(props, [].concat(_toConsumableArray((0, _lodash.keys)(_reduxForm.propTypes)), ['clearSubmitErrors'])));
};
