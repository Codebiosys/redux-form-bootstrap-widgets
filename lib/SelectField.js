...
var SelectField = _wrapComponent('SelectField')((_temp = _class = function (_Component) {
  ...
  _createClass(SelectField, [{
    ...
    value: function render() {
      ...
      return _react3.default.createElement(
        ...
        !isAsync ? _react3.default.createElement(_reactSelect2.default, _extends({}, this.selectProps(), {
          options: options
        }, props)) : _react3.default.createElement(_reactSelect2.default.Async, _extends({}, this.selectProps(), {
          loadOptions: options
        }, props)),
...
SelectField.__docgenInfo = {
  ...
  'props': {
    ...
    'multiple': {
      ...
      'required': false,
      'description': 'Allow multi select or single select',
      'defaultValue': {
        'value': 'false',
        'computed': false
      }
    ...
    'options': {
      ...
      'required': true,
      'description': 'Either an array of objects that have a shape that includes\n      the labelKey and valueKey, or a promise that resolves\n      such an array'
    },
    'labelKey': {
      'type': {
        'name': 'string'
      ...
      'required': false,
      'description': 'The key that is used as the select label',
      'defaultValue': {
        'value': '\'label\'',
        'computed': false
      }
    ...
    'valueKey': {
      ...
      'required': false,
      'description': 'The key that is used as the select value',
      'defaultValue': {
        'value': '\'value\'',
        'computed': false
      }
